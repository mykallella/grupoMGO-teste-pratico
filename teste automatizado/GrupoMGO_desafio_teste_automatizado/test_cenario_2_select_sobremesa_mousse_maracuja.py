...
class TestFormularioConviteFesta:
    ...
    def test_cenario_2_select_sobremesa_mousse_maracuja(self):
        ...
        select_sobremesa_mousse_maracuja = (By.XPATH, '//*[text()="Escolha uma sobremesa"]/parent::node()/parent::node()/parent::node()/parent::node()/div[2]/div/div[2]/div[4]/span[text()="Mousse de maracujá"]')
        ...
        driver.find_element(*select_sobremesa_mousse_maracuja).click()
