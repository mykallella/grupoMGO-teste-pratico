...
class TestFormularioConviteFesta:
    ...
    def test_cenario_3_select_sobremesa_pave_passego(self):
        ...
        select_sobremesa_pave_pessego = (By.XPATH, '//*[text()="Escolha uma sobremesa"]/parent::node()/parent::node()/parent::node()/parent::node()/div[2]/div/div[2]/div[5]/span[text()="Pavé de pêssego"]')
        ...
        driver.find_element(*select_sobremesa_pave_pessego).click()
