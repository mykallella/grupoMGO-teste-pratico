...
class TestFormularioConviteFesta:
    ...
    def test_cenario_5_radio_nao_pode_participar(self):
        ...
        radio_nao_vai_participar = (By.XPATH, '//*[@data-value="Não participarei"]')
        ...
        select_sobremesa_sorvete_flocos = (By.XPATH, '//*[text()="Escolha uma sobremesa"]/parent::node()/parent::node()/parent::node()/parent::node()/div[2]/div/div[2]/div[6]/span[text()="Sorvete de flocos"]')
        ...
        driver.find_element(*select_sobremesa_sorvete_flocos).click()

        # Escolhe se pode participar
        driver.find_element(*radio_nao_vai_participar).click()
        ...
        assert texto_formulario_enviado_sucesso_encontrado.is_displayed(), f'Esperado que o elemento {texto_formulario_enviado_sucesso_encontrado} esteja na tela'
